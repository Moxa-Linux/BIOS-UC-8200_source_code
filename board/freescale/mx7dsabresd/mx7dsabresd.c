...
#define PIO_INPUT_PULL_UP (PAD_CTL_PUE | PAD_CTL_PUS_PU47KOHM)
/* I2C1 for PMIC */
...
{
         return (bus == 1 && cs == 0) ? (IMX_GPIO_NR(4, 19)) : -1;
}
...
static iomux_v3_cfg_t const usdhc1_pads[] = {
	...
	MX7D_PAD_SD1_CD_B__SD1_CD_B | MUX_PAD_CTRL(USDHC_PAD_CTRL),
...
static iomux_v3_cfg_t const iox_pads[] = {
	...
	/* USB_OTG2_RST */
	MX7D_PAD_UART3_RTS_B__GPIO4_IO6 | MUX_PAD_CTRL(NO_PAD_CTRL),
	/* MPCIE2 DIS */
        MX7D_PAD_UART3_TX_DATA__GPIO4_IO5 | MUX_PAD_CTRL(NO_PAD_CTRL),
        /* WIFI_PWR_EN */ 
        MX7D_PAD_ECSPI2_SCLK__GPIO4_IO20 | MUX_PAD_CTRL(NO_PAD_CTRL),
        /*BT_EN*/
        MX7D_PAD_ECSPI2_SS0__GPIO4_IO23 | MUX_PAD_CTRL(NO_PAD_CTRL),
        /* LTE_PWR_EN */
        MX7D_PAD_UART3_CTS_B__GPIO4_IO7 | MUX_PAD_CTRL(NO_PAD_CTRL),
        /* DEBUG LED1 */
        MX7D_PAD_SAI1_MCLK__GPIO6_IO18 | MUX_PAD_CTRL(NO_PAD_CTRL),
        /* DEBUG LED2 */
        MX7D_PAD_SAI1_RX_DATA__GPIO6_IO12 | MUX_PAD_CTRL(NO_PAD_CTRL),
        /* DEBUG LED3 */
        MX7D_PAD_SAI1_RX_BCLK__GPIO6_IO17 | MUX_PAD_CTRL(NO_PAD_CTRL),
        /* DEBUG LED4 */
        MX7D_PAD_SAI1_RX_SYNC__GPIO6_IO16 | MUX_PAD_CTRL(NO_PAD_CTRL),
        /* DEBUG LED5 */
        MX7D_PAD_SAI1_TX_DATA__GPIO6_IO15 | MUX_PAD_CTRL(NO_PAD_CTRL),
        /*USER BUTTON*/
        MX7D_PAD_SD2_RESET_B__GPIO5_IO11 | MUX_PAD_CTRL(PIO_INPUT_PULL_UP),
};
...
static void iousb_init(void)
{
	gpio_direction_output(IOX_USB1_SW, 1);
        //gpio_direction_output(IOX_USB1_PWR, 1);
        gpio_direction_output(IOX_USB1_OC, 0);

	gpio_direction_output(IOX_USB2_HUB_RST, 1);
	//gpio_direction_output(IOX_MCPIE2_DIS, 1);
	//gpio_direction_output(IOX_USB2_PWR, 1);
	gpio_direction_output(IOX_USB2_OC, 0);
}

static void io_direction_init(void)
{
	imx_iomux_v3_setup_multiple_pads(iox_pads, ARRAY_SIZE(iox_pads));

        gpio_request(PIO_SW_BUTTON, "sw_button");
        gpio_direction_input(PIO_SW_BUTTON);

	gpio_direction_output(IOX_BEEP, 0);


	gpio_direction_output(IOX_WIFI_PWR_EN, 1);
	gpio_direction_output(IOX_BT_EN, 1);
	/*gpio_direction_output(IOX_LTE_PWR_EN, 1);
...
//	MX7D_PAD_ENET1_RGMII_RD0__ENET1_RGMII_RD0 | MUX_PAD_CTRL(ENET_RX_PAD_CTRL),       //RD0
//	MX7D_PAD_ENET1_RGMII_RD1__ENET1_RGMII_RD1 | MUX_PAD_CTRL(ENET_RX_PAD_CTRL),       //RD1
//	MX7D_PAD_ENET1_RGMII_RD2__ENET1_RGMII_RD2 | MUX_PAD_CTRL(ENET_RX_PAD_CTRL),       //RD1
//	MX7D_PAD_ENET1_RGMII_RD3__ENET1_RGMII_RD3 | MUX_PAD_CTRL(ENET_RX_PAD_CTRL),       //RD1
//	MX7D_PAD_ENET1_RGMII_RX_CTL__ENET1_RGMII_RX_CTL | MUX_PAD_CTRL(ENET_RX_PAD_CTRL), //CRS_DV
//	MX7D_PAD_ENET1_RGMII_RXC__ENET1_RX_ER | MUX_PAD_CTRL(ENET_RX_PAD_CTRL),           //RX_ER
//
//	MX7D_PAD_ENET1_RGMII_TX_CTL__ENET1_RGMII_TX_CTL | MUX_PAD_CTRL(ENET_PAD_CTRL),    //TX_EN
//	MX7D_PAD_ENET1_RGMII_TD0__ENET1_RGMII_TD0 | MUX_PAD_CTRL(ENET_PAD_CTRL),          //TD0
//	MX7D_PAD_ENET1_RGMII_TD1__ENET1_RGMII_TD1 | MUX_PAD_CTRL(ENET_PAD_CTRL),          //TD1
//	MX7D_PAD_ENET1_RGMII_TD2__ENET1_RGMII_TD2 | MUX_PAD_CTRL(ENET_PAD_CTRL),          //TD1
//	MX7D_PAD_ENET1_RGMII_TD3__ENET1_RGMII_TD3 | MUX_PAD_CTRL(ENET_PAD_CTRL),          //TD1
//	MX7D_PAD_ENET1_TX_CLK__CCM_ENET_REF_CLK1 | MUX_PAD_CTRL(ENET_PAD_CTRL),           //REF_CLK1
//
...
//	MX7D_PAD_EPDC_SDCLK__ENET2_RGMII_RD0 | MUX_PAD_CTRL(ENET_RX_PAD_CTRL),            //RD0
//	MX7D_PAD_EPDC_SDLE__ENET2_RGMII_RD1 | MUX_PAD_CTRL(ENET_RX_PAD_CTRL),             //RD1
//	MX7D_PAD_EPDC_SDCE0__ENET2_RGMII_RX_CTL | MUX_PAD_CTRL(ENET_RX_PAD_CTRL),         //CRS_DV
//	MX7D_PAD_EPDC_SDCE1__ENET2_RX_ER | MUX_PAD_CTRL(ENET_RX_PAD_CTRL),                //RX_ER
//
//	MX7D_PAD_EPDC_GDRL__ENET2_RGMII_TX_CTL | MUX_PAD_CTRL(ENET_PAD_CTRL),             //TX_EN
//	MX7D_PAD_EPDC_SDCE2__ENET2_RGMII_TD0 | MUX_PAD_CTRL(ENET_PAD_CTRL),               //TD0
//	MX7D_PAD_EPDC_SDCE3__ENET2_RGMII_TD1 | MUX_PAD_CTRL(ENET_PAD_CTRL),               //TD1
//	MX7D_PAD_EPDC_BDR0__CCM_ENET_REF_CLK2 | MUX_PAD_CTRL(ENET_PAD_CTRL),              //REF_CLK2
};
...
#ifdef CONFIG_FEC_MXC_PHY2ADDR
	ret = fecmxc_initialize_multi(bis, 1,
		CONFIG_FEC_MXC_PHY2ADDR, IMX_FEC_BASE2);
	if (ret)
...
//	printf("%p:0x%lx\n\n", &iomuxc_gpr_regs->gpr[1], (volatile u32)(iomuxc_gpr_regs->gpr[1]));
	clrsetbits_le32(&iomuxc_gpr_regs->gpr[1],
		(IOMUXC_GPR_GPR1_GPR_ENET1_TX_CLK_SEL_MASK |
		 IOMUXC_GPR_GPR1_GPR_ENET1_CLK_DIR_MASK    |
		 IOMUXC_GPR_GPR1_GPR_ENET2_TX_CLK_SEL_MASK |
		 IOMUXC_GPR_GPR1_GPR_ENET2_CLK_DIR_MASK), 0);
	//*(volatile u32*) (&iomuxc_gpr_regs->gpr[1]) = ((*(volatile u32*)(&iomuxc_gpr_regs->gpr[1])) | (1 << 17 | 1 << 13));
	//printf("%p:0x%lx\n\n", &iomuxc_gpr_regs->gpr[1], (volatile u32)(iomuxc_gpr_regs->gpr[1]));
...
int board_phy_config(struct phy_device *phydev)
{
	...
	/*set REF_CLK as output from PHY for RTL 8201F*/
//	phy_write(phydev, MDIO_DEVAD_NONE, 0x1f, 0x0007);
//	phy_write(phydev, MDIO_DEVAD_NONE, 0x10, 0x0ffa);
