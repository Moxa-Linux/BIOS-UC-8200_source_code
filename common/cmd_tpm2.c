...
int spi_tpm_init(void)
{
	...
	slave = mxc_spi_setup_slave(TPM_SPI_BUS, TPM_SPI_CS, TPM_SPI_FREQ, TPM_SPI_MODE);
...
//	printf( "read_spi_bytes_1\n");
	...
	mxc_spi_xfer(slave, t_len * 8, &tx_buf, &rx_buf, SPI_XFER_BEGIN);
